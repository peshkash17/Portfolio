        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/peshkash17/kalpesh-linkedin-ai-reply" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>LinkedIn AI Assistant Chrome Extension</h3>
              <p>
              Developed a Chrome extension using WXT (Web Extension Framework) to streamline the development process with modern tooling.Created an AI-powered messaging assistant that helps users generate contextual responses on LinkedIn conversations.Leveraged WXT's build system and TypeScript support to implement robust extension architecture with React components.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
